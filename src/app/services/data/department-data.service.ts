    ...
    const mockDepartments: IDepartmentDTO[] = [
      {
        ...
        subDepartments: [
            ...
            subDepartments: [
              {
                ...
                positions: [
                  ...
                  },
                  {
                    ...
                    email: "vladimir.zaicev@example.com",
                ...
                subDepartments: [
                  {
                    ...
                    positions: [
                      ...
                      },
                      {
                        ...
                        parentNodeId: "e1f2a3b4-5c6d-47e8-92b3-8a4d6f5b9c1e",
                        headOfDepartment: false,
                        email: "maksim.sergeev@example.com",
                        hireDate: new Date("2021-14-01"),
                        salary: 940000,
                      },
                      {
                      ...
                      },
                      {
                        ...
                        parentNodeId: "e1f2a3b4-5c6d-47e8-92b3-8a4d6f5b9c1e",
                        headOfDepartment: false,
                        email: "vladislav.morozov@example.com",
                      ...
                      },
                      {
                        ...
                        parentNodeId: "e1f2a3b4-5c6d-47e8-92b3-8a4d6f5b9c1e",
                        headOfDepartment: false,
                        email: "roman.grigoryev@example.com",
                  ...
                  },
                  {
                    ...
                    positions: [
                      ...
                      },
                      {
                        ...
                        parentNodeId: "c2d3e4f5-6a7b-48c1-92e5-7b3a1d6c8f5e",
                        headOfDepartment: true,
                        email: "gennady.morozov@example.com",
                      ...
                      },
                      {
                        ...
                        parentNodeId: "c2d3e4f5-6a7b-48c1-92e5-7b3a1d6c8f5e",
                        headOfDepartment: false,
                        email: "alexander.vasilyev@example.com",
                      ...
                      },
                      {
                        ...
                        parentNodeId: "c2d3e4f5-6a7b-48c1-92e5-7b3a1d6c8f5e",
                        headOfDepartment: false,
                        email: "victor.semenov@example.com",
          ...
          {
            id: "d4e5f6a7-8b9c-41b2-93a5-6f7e8c5d3a1b",
            name: "Департамент развития",
            hierarchyLevel: 1,
            positions: [
              {
                id: "b7d8c9a5-3e6a-47e2-a5c7-8c9b8e3f5d67",
                firstName: "Максим",
                lastName: "Абрамов",
                middleName: "Иванович",
                ...
                headOfDepartment: true,
                email: "maksim.abramov@example.com",
            ...
            subDepartments: [
              {
                id: "e5f6a7b8-9c1d-42b3-83e7-4a5d6f2c9b1e",
                name: "Отдел SEO",
                hierarchyLevel: 2,
                positions: [
                  {
                    id: "e6d8c9a7-3f5a-41d2-b8c7-9c8b8e2f7d89",
                    firstName: "Анастасия",
                    lastName: "Кравцова",
                    ...
                    headOfDepartment: false,
                    email: "anastasia.kravtsova@example.com",
                    hireDate: new Date("2024-08-15"),
                    salary: 370000,
                  },
                  {
                    id: "f9d8c7b4-3a5b-49d3-c7a8-8b9e8e7f6d12",
                    firstName: "Светлана",
                    lastName: "Ефимова",
                    ...
                    parentNodeId: "e5f6a7b8-9c1d-42b3-83e7-4a5d6f2c9b1e",
                    headOfDepartment: false,
                    email: "svetlana.efimova@example.com",
                    hireDate: new Date("2024-09-20"),
                    salary: 280000,
                  },
                  {
                    id: "c7e8d9a6-4b5a-41d2-b8f8-9b9e9e1f6c34",
                    firstName: "Дмитрий",
                    lastName: "Орлов",
                    middleName: "Викторович",
                    position: "SEO-специалист",
              ...
              {
                id: "a6b7c8d9-1e2f-43b4-82c6-3f4a7d5e9b2c",
                name: "Команда контента",
                hierarchyLevel: 2,
                positions: [
                  {
                    id: "d7e8c9b5-2f6a-47b2-c5d8-8b9e8e2f6e23",
                    firstName: "Илья",
                    lastName: "Воронов",
                    ...
                    headOfDepartment: true,
                    email: "ilya.voronov@example.com",
                    hireDate: new Date("2023-07-10"),
                    salary: 290000,
                  },
                  {
                    id: "d9f8c7e4-3a5b-49e2-c7a8-8b9e9f6d7e23",
                    firstName: "Николай",
                    lastName: "Петров",
                    middleName: "Александрович",
                    position: "Копирайтер",
                  ...
                  {
                    id: "e8d9f7b6-4c5a-42e2-b9c7-9d9e7e1f7d23",
                    firstName: "Вероника",
                    lastName: "Павленко",
                    middleName: "Олеговна",
                    position: "Редактор",
                    parentNodeId: "a6b7c8d9-1e2f-43b4-82c6-3f4a7d5e9b2c",
                    headOfDepartment: false,
                    email: "veronika.pavlenko@example.com",
              ...
              {
                id: "f7a8b9c1-2d3e-45b6-91c8-2e5d6f7a3b4c",
                name: "Отдел контекстной рекламы",
                hierarchyLevel: 2,
                positions: [
                  {
                    id: "f9d8b6e4-2c5b-41e3-b6a8-9d9f9f6c7d45",
                    firstName: "Полина",
                    lastName: "Сидорова",
                    middleName: "Андреевна",
                    position: "Аналитик",
                    ...
                    headOfDepartment: true,
                    email: "polina.sidorova@example.com",
                    hireDate: new Date("2023-10-25"),
                    salary: 400000,
                  },
                  {
                    id: "h8d9b5e3-2c5a-41e4-b7a8-9c8f9e7d7e56",
                    firstName: "Алиса",
                    lastName: "Иванова",
                    middleName: "Владимировна",
                  ...
                  {
                    id: "i8e9b5d4-2b5a-41e5-c7b8-9c7f8e6d7f45",
                    firstName: "Марина",
                    lastName: "Кузнецова",
            ...
            subDepartments: [
              {
                ...
                positions: [
                  ...
                  },
                  {
                    ...
                    parentNodeId: "2b3c4d5e-6f7a-48b9-82c3-4d5e6f7a8b1c",
                    headOfDepartment: false,
                    email: "ksenia.zelenovskaya@example.com",
